...
<head>
    ...
    <title>Trip to London | Nakamura Tour &amp; Travels</title>
        ...
        <div class="trip-details-header">
            <div class="trip-details-heading">
                <div class="trip-details-title-row">
                    <h1>Trip to London</h1>
                    <span class="trip-status-pill status-upcoming-pill">Upcoming</span>
                </div>
                ...
                <div class="trip-details-meta-row">
                    ...
                    <span class="trip-details-meta-type">Round trip</span>
                </div>
            </div>
            ...
            <div class="trip-details-main">
                ...
                <div class="trip-details-card">
                    ...
                    <div class="trip-tab-panel is-active" data-trip-panel="itinerary">
                        <?php include __DIR__ . '/includes/trip-itinerary-roundtrip.php'; ?>
                    </div>
