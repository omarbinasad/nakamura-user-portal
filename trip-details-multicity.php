...
<head>
    ...
    <title>Trip to Paris | Nakamura Tour &amp; Travels</title>
        ...
        <div class="trip-details-header">
            <div class="trip-details-heading">
                <div class="trip-details-title-row">
                    <h1>Trip to Paris</h1>
                    <span class="trip-status-pill status-request-pill">On Request</span>
                </div>
                ...
                <div class="trip-details-meta-row">
                    ...
                    <span class="trip-details-meta-type">Multi-city</span>
                </div>
            </div>
            ...
            <div class="trip-details-main">
                ...
                <div class="trip-details-card">
                    ...
                    <div class="trip-tab-panel is-active" data-trip-panel="itinerary">
                        <?php include __DIR__ . '/includes/trip-itinerary-multicity.php'; ?>
                    </div>
